    ...
    const handleGoogleAuth = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    window.location.href = `/profile/${response.data.data.InfluencerID}`;
                }, 2000);
            } else {
                toast.update(toastId, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Normalize API response: handle both data[0] and data.InfluencerID
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <button
                    ...
                    disabled={loading}
                    className={`w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200 mb-4 ${
